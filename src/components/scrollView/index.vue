  ...
  methods: {
    ...
    touchmoveEvent(e) {
      ...
      if (moveY > 0) {
        ...
        if (scrollTop <= 0 && !e.target.className.includes(this.elem)) e.preventDefault();
        ...
        if (scrollBottom <= 0 && !e.target.className.includes(this.elem)) e.preventDefault();
      }
    }
  }
};
